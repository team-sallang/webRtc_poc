import { e as equals$2, c as coerce, b as base32, a as base58btc, d as base36, s as sha256$1, f as concat$1, u as utf8ToBytes, v as version_0, g as allocUnsafe, h as alloc, i as encodingLength$1, j as encode$3, k as decode$4, L as Logger, F as FilterSubscribeRequest, l as FilterSubscribeResponse$1, M as MessagePush, P as PushRpc$1, m as LightPushRequestV3, n as LightPushResponseV3, S as StoreQueryRequest$1, o as StoreQueryResponse$1, t as toString, p as fromString, q as hexToBytes, r as isBytes, w as abytes, x as bytesToHex, y as concatBytes, z as anumber, A as randomBytes, B as sha512, C as enumeration, D as message, E as encodeMessage, G as decodeMessage, H as Hash, I as ahash, J as toBytes, K as clean, N as aexists, O as sha256$2, Q as bases, R as base64url, T as encodeUint8Array, U as bytesToUtf8, V as numberToBytes, W as createEncoder, X as WakuMetadataRequest, Y as WakuMetadataResponse } from './version_0-CPH5t8Ck.js';
export { Z as createDecoder, _ as messageHash, $ as messageHashStr } from './version_0-CPH5t8Ck.js';
...
class ConnectionLimiter {
    ...
    async maintainTTLConnectedPeers() {
        log$6.info(`Maintaining TTL connected peers`);
        const promises = this.libp2p.getConnections().map(async (c) => {
            try {
                ...
                log$6.info(`TTL updated for connected peer ${c.remotePeer.toString()}`);
            }
            catch (error) {
                log$6.error(`Unexpected error while maintaining TTL connected peer`, error);
            }
        });
        await Promise.all(promises);
    }
