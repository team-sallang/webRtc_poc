...
import { ChannelId, ContentMessage, HistoryEntry, Message, MessageId, SenderId, SyncMessage } from "./message.js";
...
export declare class MessageChannel extends TypedEventEmitter<MessageChannelEvents> {
    ...
    private tasks;
    private handlers;
    constructor(channelId: ChannelId, senderId: SenderId, options?: MessageChannelOptions, localHistory?: ILocalHistory);
